...
window.fruitIcons = {
    ...
    getByCategory: function(category) {
        switch(category) {
            case 'science':
                return this.science[Math.floor(Math.random() * this.science.length)];
            case 'nature':
                return this.nature[Math.floor(Math.random() * this.nature.length)];
            case 'space':
                return this.space[Math.floor(Math.random() * this.space.length)];
            case 'history':
                return this.history[Math.floor(Math.random() * this.history.length)];
            case 'tech':
                return this.tech[Math.floor(Math.random() * this.tech.length)];
            case 'math':
